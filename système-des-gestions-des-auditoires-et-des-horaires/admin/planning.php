...
<section class="card table-wrap">
    <div class="table-tools">
        ...
        <input class="table-filter" type="search" data-table-filter="#planning-results-table" placeholder="Rechercher dans le planning...">
    </div>
    <table id="planning-results-table">
        <thead>
        <tr>
            <th>#</th>
            <th>Jour / Heure</th>
            ...
            <div class="card" style="margin-top: 14px;">
                ...
                <?php else: ?>
                    <div class="table-wrap">
                        <div class="table-tools">
                            <h4 style="margin: 0;">Séances du jour</h4>
                            <input class="table-filter" type="search" data-table-filter="#week-table-<?= htmlspecialchars($date) ?>" placeholder="Filtrer ce jour...">
                        </div>
                        <table id="week-table-<?= htmlspecialchars($date) ?>">
                            <thead>
                            <tr>
                                <th>Heure</th>
                                <th>Cours</th>
