...
<header class="topbar">
    <div class="container topbar-inner">
        ...
        <nav class="menu">
            ...
            <?php if ($loggedIn): ?>
                <a class="<?= str_contains($currentPath, '/admin/password.php') || str_contains($currentPath, '/admin/admins.php') ? 'active' : '' ?>" href="<?= htmlspecialchars(url('admin/password.php')) ?>"><?= isSuperAdmin() ? 'Administration' : 'Mon espace' ?></a>
